          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text("Chúng tôi rất coi trọng việc bảo mật thông tin của bạn. Để bảo vệ các quyền của bạn một cách hiệu quả hơn, chúng tôi đã cung cấp Chính Sách Bảo Mật của Garena để giải thích chi tiết về các cách thức bảo mật thông tin của chúng tôi. Vui lòng xem Chính Sách Bảo Mật để hiểu được cách thức Garena thu thập và sử dụng thông tin liên kết với Tài Khoản của bạn và/hoặc việc bạn sử dụng Các Dịch Vụ. Bằng việc truy cập hoặc sử dụng Các Dịch Vụ hoặc đồng ý với các Điều Khoản Dịch Vụ này, bạn đồng ý cho phép Garena thu thập, sử dụng, tiết lộ, xử lý và/hoặc chuyển Nội Dung và dữ liệu cá nhân của bạn như mô tả trong Chính Sách Bảo Mật này.",style: TextStyle(fontSize: 18, color: Colors.black)),
                Text("Chúng tôi bảo lưu quyền chỉnh sửa các Điều Khoản Dịch Vụ này vào bất kỳ lúc nào hoặc trên cơ sở thông báo cho Người dùng, phù hợp với pháp luật hiện hành. Chúng tôi sẽ cập nhật định kỳ cho bạn bất kỳ sửa đổi nào đối với các Điều Khoản Dịch vụ này, bao gồm cả việc đăng các Điều Khoản Dịch vụ đã sửa đổi đó tại đây. Chúng tôi khuyến khích bạn kiểm tra trang này thường xuyên để ghi nhận bất kỳ thay đổi nào. Trong phạm vi tối đa được pháp luật cho phép, việc bạn tiếp tục truy cập hoặc sử dụng Dịch vụ sẽ được coi là sự chấp nhận không thể hủy ngang đối với những sửa đổi đó.",style: TextStyle(fontSize: 18, color: Colors.black)),
